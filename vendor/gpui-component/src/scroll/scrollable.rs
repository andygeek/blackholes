        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(self.element.flex_1().map(|this| match axis {
                        ScrollbarAxis::Vertical => this.w_full().min_w_0(),
                        ScrollbarAxis::Horizontal => this.h_full().min_h_0(),
                        ScrollbarAxis::Both => this.size_full().min_w_0().min_h_0(),
                    })),
            )
