...
9. Parsed terminal state remains in Rust and is never serialized to React or provider account helpers.
...
18. The terminal element tree is absent while a file, project overview, or task details page is visible; PTYs continue running without being rendered.
